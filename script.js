// declare gloal variables and intitalize
let num1 = 0;
let tempNum1Array = [];
let num2 = 0;
let tempNum2Array = [];
...
function divide (num1, num2) {
    ...
    //error check for division by 0, cant divide by zero
    if (divideValue == "Infinity") {
        return alert("Error! Can not divide by zero! You should know better than that.");
    } else {
...
function operate(operator, num1, num2) {
    switch (operator) {
        ...
        case "/" :
            ...
            break;
        default :
            alert("ERROR! Did not receive an operator, or type not as expected!");
    }
}
...
function runCalculator() {
    function getNumberClicked() {
        ...
        operandButtons.forEach((button) => {
            button.addEventListener('click', () => {
                ...
                // append to num2 if multple number are pressed and display out
    ...
    function getOperatorSelection() {
        ...
        operatorButtons.forEach((button) =>  {
            button.addEventListener('click', () => {
                ...
                console.log("store temp operator in arry for string calcs: ", tempOperatorArray);
    ...
    const decimalButton = document.querySelector(".decimal");
        decimalButton.addEventListener('click', () => {
            ...
            if (operator == "") {
                ...
                // append "decimal" to numarray2 and displayout
                const calcDisplay = document.querySelector("#display");
                console.log("decimal button registered here!", decimalButton);
    ...
    // call/run the advanced sub-fuctions
    getNumberClicked();
